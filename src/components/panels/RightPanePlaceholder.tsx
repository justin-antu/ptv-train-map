...
const UPCOMING = [
  { icon: LineChart, title: "Network insights", description: "Historical punctuality trends per line." },
...
/**
 * Reserved right-pane space for future features — deliberately quiet for now
 * (a subtle dot-pattern backdrop + a few dashed "coming soon" preview tiles)
 * rather than empty dead space.
 */
export function RightPanePlaceholder() {
  return (
